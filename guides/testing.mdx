---
title: "Test the Discord Music Bot Using Pytest and Watchdog"
...
| `mock_bot_presence`_(autouse)_ | function | Patches `bot.bot.change_presence` with `AsyncMock`; auto-applied to every test |
| `clean_active_players`_(autouse)_ | function | Calls `bot.ACTIVE_PLAYERS.clear()` before and after each test; auto-applied to every test |
